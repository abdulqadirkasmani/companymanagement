                    ...
                    <div class="shipment-tabs">
                        ...
                        <div class="tab-boxes">
                                                    ...
                                                    <div class="basic-form">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="mb-3 col-md-4">
                                                                ...
                                                                <input type="number" class="form-control" name="index_no" value="<?php echo $shipmentArr['index_no']; ?>" autocomplete="new-password">
                                                            </div>
                                                        </div>
                                                        <hr>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="mb-3 col-md-4">
                                                                ...
                                                                <input type="number" step="any" class="form-control" name="net_weight" value="<?php echo $shipmentArr['net_weight']; ?>" autocomplete="new-password">
                                                            </div>
                                                        </div>
                                                        <hr>
                                                        <div class="row">
                                                            ...
                                                            <div class="mb-3 col-md-4">
                                                                ...
                                                                <input type="text" class="form-control" value="<?php echo $shipmentArr['gd_number']; ?>" name="gd_number" autocomplete="new-password">
                                                            </div>
                                                                ...
                                                                <tbody class="container-tr">
                                                                    ...
                                                                    if($shipmentArr['container_no'] != '') {
                                                                        ...
                                                                        for($i = 0; $i < count($container_noArr); $i++) {
                                                                            ...
                                                                            <tr>
                                                                                <td style="width: 5%;"><?php echo ($i + 1); ?>.</td>
                                                                                <td><input type="text" class="form-control" value="<?php echo $container_noArr[$i] ?>" name="container_no[]" autocomplete="new-password"></td>
                                                                                <td>
                                                    ...
                                                    <div class="basic-form">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="mb-3 col-md-4">
                                                                ...
                                                                <input type="number" class="form-control" name="invoice_value" value="<?php echo $shipmentArr['invoice_value']; ?>" autocomplete="new-password">
                                                            </div>
                                                        </div>
                                                        <hr>
                                                        <div class="row">
                            ...
                            <div class="tab-box" data-tab="commodity-tab">
                                ...
                                <?php 
                                    $style = '';
                                    if($shipmentArr['shipment_mode'] != 'Air LCL' || $shipmentArr['shipment_mode'] == '') {
                                        $style = 'style="display: none"';
                                    } 
                                ?>
                                                    ...
                                                    <div class="basic-form">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="mb-3 col-md-4">
                                                                ...
                                                                <input type="text" placeholder="DD/MM/YYYY" class="date-field form-control" value="<?php echo ($shipmentArr['noc_valid_till'] != '') ? date('d/m/y', strtotime($shipmentArr['noc_valid_till'])) : ''; ?>" name="noc_valid_till" autocomplete="new-password">
                                                            </div>
                                                            <div class="mb-3 col-md-4">
                                                        ...
                                                        <div class="row">
                                                            <div class="mb-3 col-md-4">
                                                                ...
                                                                <input type="text" placeholder="DD/MM/YYYY" class="date-field form-control" value="<?php echo ($shipmentArr['eir_received_on'] != '') ? date('d/m/y', strtotime($shipmentArr['eir_received_on'])) : ''; ?>" name="eir_received_on" autocomplete="new-password">
                                                            </div>
                                                            <div class="mb-3 col-md-4">
                                                                <label class="form-label">Refund Case submit on</label>
                                                                <input type="text" placeholder="DD/MM/YYYY" class="date-field form-control" value="<?php echo ($shipmentArr['refund_case_submit_on'] != '') ? date('d/m/y', strtotime($shipmentArr['refund_case_submit_on'])) : ''; ?>" name="refund_case_submit_on" autocomplete="new-password">
                                                            </div>
                                                            <div class="mb-3 col-md-4">
                                                                <label class="form-label">Deposit Refund on</label>
                                                                <input type="text" placeholder="DD/MM/YYYY" class="date-field form-control" value="<?php echo ($shipmentArr['deposit_refund_on'] != '') ? date('d/m/y', strtotime($shipmentArr['deposit_refund_on'])) : ''; ?>" name="deposit_refund_on" autocomplete="new-password">
                                                            </div>
                                                        </div>
                                                        <hr>
                                                        <div class="row">
                                                            <div class="mb-3 col-md-4">
                                                                ...
                                                                <input type="number" class="form-control" name="refund_amount" value="<?php echo $shipmentArr['refund_amount']; ?>" autocomplete="new-password">
                                                            </div>
                                                            <div class="mb-3 col-md-4">
                                                                <label class="form-label">Final Detention Amount</label>
                                                                <input type="number" class="form-control" name="final_detention_amount" value="<?php echo $shipmentArr['final_detention_amount']; ?>" autocomplete="new-password">
                                                            </div>
                                                            <div class="mb-3 col-md-4">
                                                                <label class="form-label">Free Days</label>
                                                                <input type="number" class="form-control" name="free_days" value="<?php echo $shipmentArr['free_days']; ?>" autocomplete="new-password">
                                                            </div>
                                                        </div>
                                                        <hr>
                                                        <div class="row align-items-end">
                                                            <div class="mb-3 col-md-4">
                                                                ...
                                                                <select class="form-control" name="shipping_line" autocomplete="new-password">
                                                                    ...
                                                                    ?>
                                                                            <option <?php if($shipmentArr['shipping_line'] == $shipping_line_arr['id']) { echo 'selected=""'; } ?> value="<?php echo $shipping_line_arr['id'] ?>"><?php echo $shipping_line_arr['name'] ?></option>
                                                                    <?php } ?>
                                                                </select>
                                                            </div>
                                                                    ...
                                                                    <div class="col-md-5">
                                                                        <div class="d-flex justify-content-end">
                                                                            <div class="form-check custom-checkbox mb-3 checkbox-success check-lg">
                                                                                <input type="checkbox" class="form-check-input" checked id="billDate">
                                                        ...
                                                        <table width="100%" class="form-table six-cols expense-table">
                                                            ...
                                                            if($shipmentArr['expense_description'] != ''){
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><input type="text" placeholder="DD/MM/YYYY" class="date-field form-control" value="<?php echo ($expense_rate_valid_tillArr[$i] != '') ? date('d/m/y', strtotime($expense_rate_valid_tillArr[$i])) : ''; ?>" name="expense_rate_valid_till[]" autocomplete="new-password"></td>
                                                                    <td>
                                                                    ...
                                                                    <td><input type="text" class="form-control" name="expense_amount[]" value="<?php echo $expense_amountArr[$i] ?>" autocomplete="new-password"></td>
                                                                </tr>
                                                            <?php } 
                                                            }?>
                                                        </table>
                                                            ...
                                                            if($shipmentArr['document_name'] != ''){
                                                             ...
                                                             ?>
                                                                    <tr>
                                                                        ...
                                                                        <td><input type="text" class="form-control" name="document_remarks[]" value="<?php echo $document_remarksArr[$i] ?>" autocomplete="new-password"></td>
                                                                        <td>
                                                                            <div class="d-flex align-items-center">
